...
> Adaptive control reduced mean waiting time by about 5.18% to 7.24% across the benchmark
...
| What is your best result? | Adaptive control reduced mean wait in all five benchmark scenarios, with improvements from about 5.18% to 7.24%. |
| Did adaptive always improve every metric? | No. It improved mean wait and completed vehicles in every scenario, but maximum queue increased slightly in the alternating-peak scenario. |
