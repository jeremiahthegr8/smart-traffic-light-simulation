...
from trafficlight.simulation.benchmark import benchmark_rows_to_dicts, run_benchmark
...
class BenchmarkRequest(BaseModel):
    scenarios: list[str] = Field(default_factory=lambda: ["balanced", "ns-heavy", "ew-heavy"])
...
def create_app(db_path: str | Path = "trafficlight.db") -> FastAPI:
    ...
    def create_benchmark(request: BenchmarkRequest) -> dict:
        ...
        return {"rows": benchmark_rows_to_dicts(rows)}
